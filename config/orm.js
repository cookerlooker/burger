// Import(require) connection.js into orm.jsfunction
...
function objToSql(ob) {
  ...
  // loop through the keys and push the key/value as a string int arr
    for (var key in ob) {
        ...
        // if string with spaces, add quotations (Ms Rochelle Schofield => 'Ms Rochelle Schofield')
...
insertOne: function(tableInput, valOfCol, valOfOtherCol, cb) {
    var queryString = "INSERT INTO " + tableIput;
    queryString += " (";
